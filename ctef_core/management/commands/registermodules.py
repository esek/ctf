...
from ctef_core.models import TaskModule, Task, TaskClue
from ctef_core.decorators import MODULE_TASKS, TaskDesc
from ctef_core.common import fetch_ctf_modules, get_module_key
